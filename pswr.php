...
function check_login($dbc, $shopperemail = '') {
	...
	if ($check) { // OK!
		...
		// Redirect:
		header("Location: http://www.waxmode.com/responsive2/pswr2.php");
			
	} else { // Unsuccessful!

		// Assign $data to $errors for pswr.php:
		$errors = $data;
    ...
    <div id="bottom">
		...
		<div id="itemdetailssection">
			...
			<div>
				...
				<table border=0 cellspacing=0 cellpadding=0 width=500 style="margin-left:333px;">
					...
					<tr>
						...
						<h1 style="padding:10px 0 30px 0;">Password Reset</h1>
						...
						Enter below, the email address you registered with  <br><br>
							...
							<table border="0" cellspacing="0" cellpadding="0" width=500>
								...
								<tr>
									<td colspan="2">
									<form action="pswr.php" method="post">
									</td>
								</tr>
								<tr height="40">
									<td width="110">Email <span id="redtext">*</span></td>
									<td><input id="element3" maxlength="60" name="shopperemail" size="40" type="text" value="<?php if (isset($_POST['shopperemail'])) echo $_POST['shopperemail']; ?>" /></td>
								</tr>
								<tr>
									<td></td>
									<td>
