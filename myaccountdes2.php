		...
		<div id="itemdetailssection" style="height:1100px;">
			...
			<div style="width:90.14%; margin:0 auto;">
					...
					<style type="text/css">
						...
						#report td { background:#F9F9F9 none repeat-x scroll center left; color:#000; padding:5px 15px; }
								...
								<!-- Using absolute positioning here because jquery has made it impossible to space columns here -->
									...
									while ($row = mysqli_fetch_array($r2, MYSQLI_ASSOC))
										...
										echo '<div style="width:100%;">													
												...
												<div style="width:16.66%;display:inline;position:absolute;left:126px;">' . $row["Month"] . '</div>
												<div style="width:40.66%;display:inline;position:absolute;left:198px;">' . $row["productname"] . '</div>
												<div style="width:10.66%;display:inline;position:absolute;left:518px;">' . $row["pcartid"] . '</div>
												<div style="width:10.66%;display:inline;position:absolute;left:646px;">' . $row["Qty"] . '</div>
												<div style="width:10.66%;display:inline;position:absolute;left:700px;">' . $row["PriceTotal"] . '</div>
											</div>';
